...
MAKE_STRING_TEST_FUNC(test_string_01, "qjhvhtzxzqqjkmpb", 1);
MAKE_STRING_TEST_FUNC(test_string_02, "aaa", 0);
MAKE_STRING_TEST_FUNC(test_string_03, "xxyxx", 1);
MAKE_STRING_TEST_FUNC(test_string_04, "uurcxstgmygtbstg", 0);
MAKE_STRING_TEST_FUNC(test_string_05, "ieodomkazucvgmuy", 0);
