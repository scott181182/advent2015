...
MunitResult test_parse_01(const MunitParameter _params[], void* _user_data_or_fixture) { \
    ...
    munit_assert_size(booklet.wire_set.length, ==, 1);
    ...
    munit_assert_ptr_equal(booklet.instructions[0].op.unary.dst.val.wire, &booklet.wire_set.wires[0]);
    munit_assert_string_equal(booklet.wire_set.wires[0].name.data, "x");
...
MunitResult test_parse_02(const MunitParameter _params[], void* _user_data_or_fixture) { \
    ...
    munit_assert_size(booklet.instruction_count, ==, 1);
    munit_assert_size(booklet.wire_set.length, ==, 3);
    ...
    munit_assert_ptr_equal(booklet.instructions[0].op.binary.src1.val.wire, &booklet.wire_set.wires[0]);
    munit_assert_ptr_equal(booklet.instructions[0].op.binary.src2.val.wire, &booklet.wire_set.wires[1]);
    munit_assert_ptr_equal(booklet.instructions[0].op.binary.dst.val.wire, &booklet.wire_set.wires[2]);
    munit_assert_size(booklet.wire_set.wires[0].name.length, ==, 1);
    munit_assert_char(booklet.wire_set.wires[0].name.data[0], ==, 'x');
    munit_assert_size(booklet.wire_set.wires[1].name.length, ==, 1);
    munit_assert_char(booklet.wire_set.wires[1].name.data[0], ==, 'y');
    munit_assert_size(booklet.wire_set.wires[2].name.length, ==, 1);
    munit_assert_char(booklet.wire_set.wires[2].name.data[0], ==, 'z');
...
MunitResult test_parse_03(const MunitParameter _params[], void* _user_data_or_fixture) { \
    ...
    munit_assert_size(booklet.instruction_count, ==, 1);
    munit_assert_size(booklet.wire_set.length, ==, 2);
    munit_assert_char(booklet.instructions[0].type, ==, BINARY_OP);
    ...
    munit_assert_char(booklet.instructions[0].op.binary.dst.type, ==, WIRE);
    munit_assert_ptr_equal(booklet.instructions[0].op.binary.src1.val.wire, &booklet.wire_set.wires[0]);
    munit_assert_ptr_equal(booklet.instructions[0].op.binary.dst.val.wire, &booklet.wire_set.wires[1]);
    munit_assert_size(booklet.wire_set.wires[0].name.length, ==, 1);
    munit_assert_char(booklet.wire_set.wires[0].name.data[0], ==, 'p');
    munit_assert_size(booklet.wire_set.wires[1].name.length, ==, 1);
    munit_assert_char(booklet.wire_set.wires[1].name.data[0], ==, 'q');
...
MunitResult test_parse_04(const MunitParameter _params[], void* _user_data_or_fixture) { \
    ...
    munit_assert_char(booklet.instructions[0].op.unary.dst.type, ==, WIRE);
    munit_assert_ptr_equal(booklet.instructions[0].op.unary.src.val.wire, &booklet.wire_set.wires[0]);
    munit_assert_ptr_equal(booklet.instructions[0].op.unary.dst.val.wire, &booklet.wire_set.wires[1]);
    munit_assert_size(booklet.wire_set.wires[0].name.length, ==, 1);
    munit_assert_char(booklet.wire_set.wires[0].name.data[0], ==, 'e');
    munit_assert_size(booklet.wire_set.wires[1].name.length, ==, 1);
    munit_assert_char(booklet.wire_set.wires[1].name.data[0], ==, 'f');
...
MunitResult test_input(const MunitParameter _params[], void* _user_data_or_fixture) { \
    ...
    free(input); \
    munit_assert_int64(result, ==, 3176); \
    return MUNIT_OK; \
}
